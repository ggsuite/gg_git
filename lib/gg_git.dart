...
export 'src/commands/is_locked.dart';
...
export 'src/commands/remote_branch_exists.dart';
export 'src/commands/remote_branches.dart';
export 'src/commands/show_file.dart';
export 'src/commands/unstaged_files.dart';
